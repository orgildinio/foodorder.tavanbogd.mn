<template>
    <section class="page">
        ...
        <section class="page-agent-form">
            <dataform v-if="type == 'profile'" :url="baseUrl ? baseUrl : ''" class="material-form" ref="agentForm" schemaID="user_profile" :editMode="editMode" :onSuccess="onSuccess"/>
            <dataform v-if="type == 'password'" :url="baseUrl ? baseUrl : ''" class="material-form" ref="agentForm" schemaID="user_password" :editMode="editMode" :onSuccess="onSuccess"/>
        </section>
    </section>
</template>

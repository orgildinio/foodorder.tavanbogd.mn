...
func SubOronNutagUaTolvolgoo(ctx context.Context, sorts []*model.Sort, groupFilters []*model.GroupFilter, filters []*model.Filter, limit *int, offset *int) ([]*models.SubOronNutagUaTolvolgoo, error) {

	result := []*models.SubOronNutagUaTolvolgoo{}
	requestColumns, _ := gql.GetColumns(ctx, "sub_oron_nutag_ua_tolvolgoo")
	...
	columns := SubOronNutagUaTolvolgooColumns()
...
func SubOronNutagUaTolvolgooColumns() []string {
	return []string{"id", "o_zovlol_id", "tailbar_mn", "tailbar_en", "tolvolgoo"}
}

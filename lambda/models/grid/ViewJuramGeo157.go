...
type ViewJuramGeo157 struct {
	...
	SourceBio           *string    `gorm:"column:source_bio" json:"source_bio"`
	Sumid               *int       `gorm:"column:sumid" json:"sumid"`
	Sumname             *string    `gorm:"column:sumname" json:"sumname"`
	UpdatedAt           *time.Time `gorm:"column:updated_at" json:"updated_at"`
}

type JuramGeologyGaubmMainTable157 struct {
	Aimagid                          *int       `gorm:"column:aimagid" json:"aimagid"`
...
func (j *JuramGeologyGaubmMainTable157) TableName() string {
	return "juram_geology_gaubm"
}

//  TableName sets the insert table name for this struct type
func (v *ViewJuramGeo157) TableName() string {
	return "view_juram_geo"
}

var ViewJuramGeo157Datagrid datagrid.Datagrid = datagrid.Datagrid{
	Name:      "Биологийн гаралтай АҮБ",
	Identity:  "id",
	DataTable: "view_juram_geo",
	MainTable: "juram_geology_gaubm",
	DataModel: new(ViewJuramGeo157),
	Data:      new([]ViewJuramGeo157),
	MainModel: new(JuramGeologyGaubmMainTable157),
	Columns: []datagrid.Column{
		...
		datagrid.Column{Model: "source_bio", Label: "Эх сурвалж"},
		datagrid.Column{Model: "info_source", Label: "Мэдээллийг хүлээн авсан суваг"},
		datagrid.Column{Model: "measure", Label: "Хэмжих нэгж"},
		datagrid.Column{Model: "form", Label: "Гамшиг, аюулт үзэгдэл, ослын бүртгэлийн маягт, дугаар"},
	},
	ColumnList: []string{"id", "aimagname", "sumname", "bagname", "aimagid", "sumid", "biology_disaster_type", "source_bio", "info_source", "measure", "form"},
	Filters: map[string]string{
		...
		"hu_huleenavsan_ognoo": "",

		"shinj_ilersen_ognoo": "",

		"onchingarsan_ognoo": "",

		"hyzgaarlah_deglem_togtooson_ognoo": "",

		"hyzgaarlah_deglem_tsutsalsan_ognoo": "",

		"horio_togtooson_ognoo": "",

		"horio_tsutsalsan_ognoo": "",

		"ba_huleen_avsan_operator": "",
		...
		"batal_baiguullaga_id": "",

		"batal_alban_tushaal_id": "",

		"batal_tsol_ovogner_id": "",

		"batal_gariin_useg_id": "",

		"batalgaajuulalt_baiguullaga_id": "",

		"batalgaajuulalt_alban_tushaal_id": "",

		"batalgaajuulalt_tsol_ovog_ner_id": "",

		"batalgaajuulalt_gariin_useg_id": "",

		"gamshig_bolson_eseh": "",

		"haldvart_ovchin_eseh": "",

		"tav_deesh_eseh": "",

		"nervegdesen_hun_eseh": "",
		...
		"hamarsan_nurgiin_hemjee": "",

		"uchirsan_bodit_hohirol_eseh": "",
		...
		"mal_ovchilson_maliin_too": "",

		"ustagsan_mal_arav_eseh": "",

		"hamrah_huree": "",

		"mal_uchirsan_hohirol_hoyor_eseh": "",

		"mail_ezleh_huvi": "",

		"batalga_alban_tushaal_id": "",
		...
		"hamrah_huree_hoyor_deesh_eseh": "",

		"horogdson_mal_arav_deesh_eseh": "",
	...
	BeforePrint:        nil,
	TriggerNameSpace:   "",
	FillVirtualColumns: fillVirtualColumnsViewJuramGeo157,
}

func fillVirtualColumnsViewJuramGeo157(rowsPre interface{}) interface{} {
	return rowsPre
}

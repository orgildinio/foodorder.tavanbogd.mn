...
func NariivchilsanUnelgee262Dataform() dataform.Dataform {
	return dataform.Dataform{
		Name:     "Нарийвчилсан үнэлгээ /Байгууллага /",
		Identity: "id",
		Table:    "nariivchilsan_unelgee",
		Model:    new(formModels.NariivchilsanUnelgee262),
		...
		SubForms: []map[string]interface{}{
			...
			map[string]interface{}{
				...
				"parentIdentity":   "id",
				"subIdentity":      "id",
				"subForm":          SubNariinUnelgeeFileNariivchilsanUnelgee262Dataform(),
				"subFormArray":     new([]formModels.SubNariinUnelgeeFileNariivchilsanUnelgee262),
			},
			map[string]interface{}{
				"connection_field": "nariin_unelgee_id",
				"tableTypeColumn":  "",
...
func SubNariinUnelgeeFileNariivchilsanUnelgee262Dataform() dataform.Dataform {
	return dataform.Dataform{
		Name:     "Хавсралт файлууд ",
		Identity: "id",
		Table:    "sub_nariin_unelgee_file",
		Model:    new(formModels.SubNariinUnelgeeFileNariivchilsanUnelgee262),
	}
}

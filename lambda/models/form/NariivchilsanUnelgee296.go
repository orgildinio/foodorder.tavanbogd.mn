...
func NariivchilsanUnelgee296Dataform() dataform.Dataform {
	return dataform.Dataform{
		Name:     "Нарийвчилсан үнэлгээ /Мэргэжилтэн /",
		Identity: "id",
		Table:    "nariivchilsan_unelgee",
		Model:    new(formModels.NariivchilsanUnelgee296),
		...
		SubForms: []map[string]interface{}{
			...
			map[string]interface{}{
				...
				"parentIdentity":   "id",
				"subIdentity":      "id",
				"subForm":          SubNariinUnelgeeFileNariivchilsanUnelgee296Dataform(),
				"subFormArray":     new([]formModels.SubNariinUnelgeeFileNariivchilsanUnelgee296),
			},
			map[string]interface{}{
				"connection_field": "nariin_unelgee_id",
				"tableTypeColumn":  "",
...
func SubNariinUnelgeeFileNariivchilsanUnelgee296Dataform() dataform.Dataform {
	return dataform.Dataform{
		Name:     "Хавсралт файлууд ",
		Identity: "id",
		Table:    "sub_nariin_unelgee_file",
		Model:    new(formModels.SubNariinUnelgeeFileNariivchilsanUnelgee296),
	}
}

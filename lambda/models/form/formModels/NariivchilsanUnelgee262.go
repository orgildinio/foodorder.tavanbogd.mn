...
type NariivchilsanUnelgee262 struct {
...
type SubNariinUnelgeeFileNariivchilsanUnelgee262 struct {
	FileNer *string `gorm:"column:file_ner" json:"file_ner"`
	ID      int     `gorm:"column:id;primaryKey;autoIncrement" json:"id"`
}

func (s *SubNariinUnelgeeFileNariivchilsanUnelgee262) TableName() string {
	return "sub_nariin_unelgee_file"
}

//  TableName sets the insert table name for this struct type
func (n *NariivchilsanUnelgee262) TableName() string {

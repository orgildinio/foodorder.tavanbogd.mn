...
type NariivchilsanUnelgee264 struct {
...
type SubNariinUnelgeeFileNariivchilsanUnelgee264 struct {
...
func (s *SubNariinUnelgeeFileNariivchilsanUnelgee264) TableName() string {
	return "sub_nariin_unelgee_file"
}

//  TableName sets the insert table name for this struct type
func (n *NariivchilsanUnelgee264) TableName() string {

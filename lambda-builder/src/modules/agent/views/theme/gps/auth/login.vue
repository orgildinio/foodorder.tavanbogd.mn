<template>
    <div class="form-content">
        ...
        <p class="login-description">{{lang.login_sub}}</p>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            // }),
            lang() {
                const labels = ['loginError', 'loginSuccess', 'forgot', 'remember', 'login', 'password', 'username', 'loginTitle', 'login_sub','logoText', 'logo'];

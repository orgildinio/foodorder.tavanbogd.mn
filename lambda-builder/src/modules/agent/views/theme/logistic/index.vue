<template>
    <div class="login">
        <div class="content">
            ...
            <div class="header">
                <div class="logo">
                    <img src="/assets/logistic/images/logo-horz.png" alt="logo"/>
                </div>

                <ul class="menu">
                    <li>
                        <a href="javascript:void(0)" @click="showFaqModal">{{lang.frequentlyAskedQuestions}}</a>
                    </li>
            ...
            <div class="footer">
                ...
                <div class="box-row app">
                    <a
                        href="#"
                    >
                        <img src="/assets/schoolAlert/images/playstore.png" alt=""/> Play
                        store
                    </a>
                    ...
                    <a
                        href="#"
                    >
                        <img src="/assets/schoolAlert/images/appstore.png" alt=""/> Apple
                        store
                    </a>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        getSlides() {
            axios.get("/logistic/api/slides").then(({data}) => {
                this.slides = data;
            });
        },
...
<style lang="scss">
@import "../../../scss/theme/logistic/style";
</style>

<template>
    <div class="form-content">
        ...
        <h2>{{ lang.forgot }}</h2>
        <p class="login-description">{{lang.plseResUrPassUsingUrRegisteredEmail}}</p>
...
<script>
    ...
    export default {
        ...
        computed: {
            lang() {
                const labels = ['forgot', 'sendPasswordResetCode', 'forgotDescription', 'email', 'plseResUrPassUsingUrRegisteredEmail', ];
